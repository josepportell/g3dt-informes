...
(8 consolidacions: 1 dialecte pla, 2 amb pèrdues, 1 candidat derivat) → **Fase 12 (Python-first + guards) passa davant de la Fase 11**. Decisions Josep: model/pla, flip v2. (`G3DT_LECTURA_MODEL=fable ~/g3dt-e2e/fase9/run.sh 3 fable-c3`, ~30-40 min:
