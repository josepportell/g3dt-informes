# Agregat M341 — mesura completa `2026-09-08-m341-tall-rubi`
...
| **Total** | 308 · 43 · 124 · 32 → **74 %** | 157 · 14 · 53 · 11 → **76 %** | 292 · 99 · 88 → **82 %** | 128 · 22 · 25 → **86 %** |
...
| linyola | 7 | 0 | 3 | — |
| alcoletge | 7 | 0 | 3 | — |
| vilanova | 8 | 1 | 1 | `fig_geological_image` |
...
|---|--:|--:|--:|--:|--:|--:|---|
| castellar | 3 | 1 | 3 | 0 | 57 % | 0 | `fig_situacio`:X, `foto_dpsh`:X, `fig_geologic`:X |
| rubi | 2 | 1 | 2 | 2 | 60 % | 0 | `fig_situacio`:X, `foto_vista`:ND, `foto_dpsh`:X, `fig_geologic`:ND |
| bell-lloc | 7 | 0 | 2 | 1 | 78 % | 0 | `fig_situacio`:ND, `fig_situacio`:X, `fig_geologic`:X |
| linyola | 1 | 1 | 4 | 1 | 33 % | 0 | `fig_situacio`:X, `fig_assaigs`:ND, `fig_projecte`:X, `foto_dpsh`:X, `fig_geologic`:X |
| alcoletge | 3 | 0 | 3 | 0 | 50 % | 0 | `fig_situacio`:X, `foto_dpsh`:X, `fig_geologic`:X |
| vilanova | 3 | 1 | 2 | 3 | 67 % | 1 | `fig_situacio`:X, `foto_vista`:X, `fig_assaigs`:ND, `fig_geologic`:ND, `foto_materials`:ND |
| anciles | 4 | 0 | 2 | 4 | 67 % | 0 | `fig_situacio`:X, `fig_projecte`:ND, `fig_projecte`:ND, `foto_sondeig`:X, `fig_geologic`:ND, `foto_materials`:ND |
| **total** | **23** | **4** | **18** | **11** | **60 %** | | |

| ranura de l'Eva | M | C | X | ND | % |
|---|--:|--:|--:|--:|--:|
| `fig_assaigs` | 4 | 0 | 0 | 2 | 100 % |
| `fig_geologic` | 0 | 0 | 4 | 3 | 0 % |
| `fig_projecte` | 2 | 0 | 1 | 2 | 67 % |
