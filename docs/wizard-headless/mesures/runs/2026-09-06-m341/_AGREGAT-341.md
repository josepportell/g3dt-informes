# Agregat M341 — mesura completa `2026-09-06-m341`
...
|---|---|---|---|---|
| castellar | 32 · 4 · 17 · 7 → **68 %** | 32 · 3 · 19 · 6 → **65 %** | 45 · 12 · 8 → **88 %** | 46 · 11 · 8 → **88 %** |
| rubi | 26 · 3 · 19 · 6 → **60 %** | 26 · 2 · 24 · 2 → **54 %** | 43 · 6 · 6 → **89 %** | 41 · 7 · 7 → **87 %** |
| bell-lloc | 31 · 7 · 18 · 3 → **68 %** | 32 · 4 · 21 · 2 → **63 %** | 39 · 6 · 10 → **82 %** | 36 · 6 · 13 → **76 %** |
| linyola | 27 · 9 · 17 · 3 → **68 %** | — | 35 · 10 · 6 → **88 %** | — |
| alcoletge | 15 · 6 · 19 · 10 → **52 %** | — | 36 · 13 · 18 → **73 %** | — |
| vilanova | 14 · 4 · 27 · 7 → **40 %** | — | 23 · 24 · 27 → **64 %** | — |
| anciles | 11 · 5 · 24 · 11 → **40 %** | — | 44 · 27 · 25 → **74 %** | — |
| **Total** | 156 · 38 · 141 · 47 → **58 %** | 90 · 9 · 64 · 10 → **61 %** | 265 · 98 · 100 → **78 %** | 123 · 24 · 28 → **84 %** |

## Per GRUP (escalars+narrativa), variant × grup, agregat dels projectes

| variant | grup | MATCH | CLOSE | MISMATCH | NO_DATA | % |
|---|---|--:|--:|--:|--:|--:|
| `viaA` | A | 80 | 11 | 40 | 16 | 69 % |
| `viaA` | calc | 57 | 5 | 32 | 2 | 66 % |
| `viaA` | narr | 8 | 18 | 61 | 22 | 30 % |
...
| `building_structure_desc` | narr | 0 | 0 | 7 | 0 |
| `materials_intro` | narr | 0 | 0 | 7 | 0 |
| `radon_zone_description` | narr | 0 | 0 | 7 | 0 |
| `site_condition` | narr | 0 | 0 | 7 | 0 |
| `conclusions_aggressivity_statement` | narr | 0 | 0 | 6 | 0 |
| `adjacent_east_fmt` | narr | 0 | 2 | 5 | 0 |
| `adjacent_south_fmt` | narr | 1 | 2 | 4 | 0 |
| `csn_radon_text` | narr | 0 | 0 | 4 | 3 |
| `adjacent_north_fmt` | narr | 0 | 4 | 3 | 0 |
| `adjacent_west_fmt` | narr | 0 | 4 | 3 | 0 |
| `conclusions_levels_detected` | narr | 5 | 0 | 2 | 0 |
| `conclusions_water_statement` | narr | 2 | 3 | 2 | 0 |
| `lab_tests_text` | narr | 0 | 2 | 2 | 3 |
| `photo_site_text` | narr | 0 | 1 | 2 | 0 |
