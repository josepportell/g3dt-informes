# Agregat M341 — mesura completa `2026-09-08-m341-peca6`
...
|---|--:|--:|--:|--:|--:|--:|---|
| castellar | 4 | 1 | 2 | 0 | 71 % | 0 | `fig_situacio`:X, `foto_dpsh`:X |
| rubi | 3 | 1 | 2 | 1 | 67 % | 0 | `fig_situacio`:X, `foto_vista`:ND, `foto_dpsh`:X |
...
| vilanova | 4 | 1 | 2 | 2 | 71 % | 1 | `fig_situacio`:X, `foto_vista`:X, `fig_assaigs`:ND, `foto_materials`:ND |
