# Agregat M341 — mesura completa `2026-09-07-m341-peca2`
...
| bell-lloc | 5 | 1 | 3 | 1 | 67 % | 0 | `fig_situacio`:ND, `fig_situacio`:X, `fig_projecte`:X, `fig_geologic`:X |
...
| anciles | 2 | 1 | 3 | 4 | 50 % | 0 | `fig_situacio`:X, `fig_projecte`:ND, `fig_projecte`:ND, `fig_assaigs`:X, `foto_sondeig`:X, `fig_geologic`:ND, `foto_materials`:ND |
| **total** | **14** | **5** | **24** | **13** | **44 %** | | |
