# Agregat M341 — mesura completa `2026-09-09-m341-altres-b`
...
| rubi | 52 · 9 · 12 · 3 → **84 %** | 50 · 8 · 16 · 2 → **78 %** | 43 · 8 · 4 → **93 %** | 41 · 8 · 6 → **89 %** |
| bell-lloc | 60 · 6 · 13 · 1 → **84 %** | 56 · 2 · 20 · 2 → **74 %** | 42 · 4 · 9 → **84 %** | 39 · 4 · 12 → **78 %** |
| linyola | 51 · 4 · 22 · 1 → **71 %** | — | 47 · 14 · 6 → **91 %** | — |
| alcoletge | 46 · 5 · 14 · 8 → **78 %** | — | 37 · 13 · 17 → **75 %** | — |
| vilanova (es) | 21 · 10 · 24 · 5 → **56 %** | — | 28 · 23 · 23 → **69 %** | — |
| anciles (es) | 24 · 7 · 24 · 8 → **56 %** | — | 45 · 27 · 24 → **75 %** | — |
| **Total** | 315 · 44 · 120 · 31 → **75 %** | 160 · 15 · 51 · 10 → **77 %** | 292 · 99 · 88 → **82 %** | 128 · 22 · 25 → **86 %** |
...
| `viaA` | narr | 34 | 29 | 40 | 6 | 61 % |
| `viaA` | fix | 81 | 0 | 21 | 0 | 79 % |
| `viaA` | resta | 16 | 4 | 3 | 7 | 87 % |
| `t2` | A | 50 | 4 | 14 | 5 | 79 % |
| `t2` | calc | 40 | 0 | 8 | 0 | 83 % |
| `t2` | narr | 16 | 11 | 20 | 2 | 57 % |
| `t2` | fix | 48 | 0 | 6 | 0 | 89 % |
| `t2` | resta | 6 | 0 | 3 | 3 | 67 % |
...
|---|---|--:|--:|--:|--:|--:|
| ca | castellar, rubi, bell-lloc, linyola, alcoletge | 31 | 19 | 26 | 3 | 66 % |
| es | vilanova, anciles | 3 | 10 | 14 | 3 | 48 % |
...
| alcoletge | 7 | 0 | 6 | — |
| vilanova | 9 | 0 | 4 | — |
| anciles | 8 | 1 | 4 | `fig_geological_image` |
...
|---|--:|--:|--:|--:|--:|--:|---|
| castellar | 5 | 1 | 1 | 0 | 86 % | 0 | `foto_dpsh`:X |
| rubi | 5 | 1 | 1 | 0 | 86 % | 0 | `foto_dpsh`:X |
| bell-lloc | 6 | 0 | 2 | 2 | 75 % | 1 | `fig_situacio`:ND, `fig_situacio`:X, `fig_projecte`:ND, `fig_geologic`:X |
| linyola | 1 | 1 | 5 | 0 | 29 % | 0 | `fig_situacio`:X, `fig_assaigs`:X, `fig_projecte`:X, `foto_dpsh`:X, `fig_geologic`:X |
| alcoletge | 4 | 0 | 2 | 0 | 67 % | 0 | `foto_dpsh`:X, `fig_geologic`:X |
| vilanova | 4 | 1 | 2 | 2 | 71 % | 1 | `fig_projecte`:ND, `foto_vista`:X, `fig_assaigs`:X, `foto_materials`:ND |
| anciles | 5 | 0 | 2 | 3 | 71 % | 0 | `fig_projecte`:X, `fig_projecte`:ND, `foto_sondeig`:X, `fig_geologic`:ND, `foto_materials`:ND |
| **total** | **30** | **4** | **15** | **7** | **69 %** | | |

| ranura de l'Eva | M | C | X | ND | % |
|---|--:|--:|--:|--:|--:|
| `fig_assaigs` | 4 | 0 | 2 | 0 | 67 % |
| `fig_geologic` | 3 | 0 | 3 | 1 | 50 % |
| `fig_projecte` | 0 | 0 | 2 | 3 | 0 % |
| `fig_situacio` | 5 | 0 | 2 | 1 | 71 % |
| `fig_tall` | 3 | 4 | 0 | 0 | 100 % |
| `foto_dpsh` | 3 | 0 | 4 | 0 | 43 % |
| `foto_materials` | 7 | 0 | 0 | 2 | 100 % |
| `foto_sondeig` | 2 | 0 | 1 | 0 | 67 % |
| `foto_vista` | 3 | 0 | 1 | 0 | 75 % |
...
| `fig_spt_cullera_num` | fix | 4 | 0 | 3 | 0 |
| `fig_geological_num` | fix | 4 | 0 | 2 | 0 |
| `section_rado_num` | fix | 5 | 0 | 2 | 0 |
| `section_sismica_num` | fix | 5 | 0 | 2 | 0 |
| `fig_assaigs_num` | fix | 2 | 0 | 1 | 0 |
| `fig_correlation_num` | fix | 4 | 0 | 1 | 0 |
| `fig_situacio_2_num` | fix | 0 | 0 | 1 | 0 |
| `photo_materials_num` | fix | 4 | 0 | 1 | 0 |
...
| `fig_situacio_num` | fix | 2 | 0 | 0 | 0 |
| `photo_dpsh_num` | fix | 5 | 0 | 0 | 0 |
