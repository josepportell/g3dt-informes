# Agregat M341 — mesura completa `2026-09-06-m341-narr2c`
...
|---|---|---|---|---|
| castellar | 36 · 5 · 12 · 6 → **77 %** | 33 · 6 · 14 · 6 → **74 %** | 45 · 12 · 8 → **88 %** | 46 · 11 · 8 → **88 %** |
| rubi | 26 · 8 · 14 · 5 → **71 %** | 27 · 5 · 19 · 2 → **63 %** | 43 · 6 · 6 → **89 %** | 41 · 7 · 7 → **87 %** |
| bell-lloc | 38 · 7 · 12 · 2 → **79 %** | 36 · 2 · 19 · 2 → **67 %** | 39 · 6 · 10 → **82 %** | 36 · 6 · 13 → **76 %** |
| linyola | 30 · 8 · 15 · 2 → **72 %** | — | 35 · 10 · 6 → **88 %** | — |
| alcoletge | 20 · 4 · 15 · 10 → **62 %** | — | 36 · 13 · 18 → **73 %** | — |
| vilanova (es) | 14 · 10 · 21 · 6 → **53 %** | — | 23 · 24 · 27 → **64 %** | — |
| anciles (es) | 14 · 7 · 20 · 9 → **51 %** | — | 44 · 27 · 25 → **74 %** | — |
| **Total** | 178 · 49 · 109 · 40 → **68 %** | 96 · 13 · 52 · 10 → **68 %** | 265 · 98 · 100 → **78 %** | 123 · 24 · 28 → **84 %** |
...
| `viaA` | narr | 29 | 29 | 36 | 15 | 62 % |
| `viaA` | resta | 11 | 4 | 8 | 7 | 65 % |
| `t2` | A | 41 | 2 | 17 | 5 | 72 % |
| `t2` | calc | 35 | 0 | 10 | 0 | 78 % |
| `t2` | narr | 14 | 11 | 22 | 2 | 53 % |
| `t2` | resta | 6 | 0 | 3 | 3 | 67 % |
...
|---|---|--:|--:|--:|--:|--:|
| ca | castellar, rubi, bell-lloc, linyola, alcoletge | 26 | 19 | 24 | 10 | 65 % |
| es | vilanova, anciles | 3 | 10 | 12 | 5 | 52 % |
...
| `conclusions_levels_detected` | narr | 4 | 3 | 0 | 0 |
| `empentes_paragraph` | narr | 0 | 0 | 0 | 2 |
| `estabilitat_paragraph` | narr | 0 | 0 | 0 | 1 |
| `materials_intro` | narr | 3 | 4 | 0 | 0 |
