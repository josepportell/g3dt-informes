# Agregat M341 — mesura completa `2026-09-07-m341-bloc2b`
...
|---|---|---|---|---|
| castellar | 42 · 3 · 9 · 5 → **83 %** | 35 · 5 · 13 · 6 → **75 %** | 50 · 10 · 5 → **92 %** | 48 · 10 · 7 → **89 %** |
| rubi | 30 · 8 · 11 · 4 → **78 %** | 28 · 7 · 15 · 3 → **70 %** | 43 · 8 · 4 → **93 %** | 41 · 8 · 6 → **89 %** |
| bell-lloc | 43 · 6 · 9 · 1 → **84 %** | 39 · 2 · 16 · 2 → **72 %** | 42 · 4 · 9 → **84 %** | 39 · 4 · 12 → **78 %** |
| linyola | 38 · 4 · 12 · 1 → **78 %** | — | 47 · 14 · 6 → **91 %** | — |
| alcoletge | 22 · 5 · 14 · 8 → **66 %** | — | 37 · 13 · 17 → **75 %** | — |
| vilanova (es) | 19 · 8 · 18 · 6 → **60 %** | — | 28 · 23 · 23 → **69 %** | — |
| anciles (es) | 14 · 7 · 21 · 8 → **50 %** | — | 45 · 27 · 24 → **75 %** | — |
| **Total** | 208 · 41 · 94 · 33 → **73 %** | 102 · 14 · 44 · 11 → **72 %** | 292 · 99 · 88 → **82 %** | 128 · 22 · 25 → **86 %** |

## Per GRUP (escalars+narrativa), variant × grup, agregat dels projectes

| variant | grup | MATCH | CLOSE | MISMATCH | NO_DATA | % |
|---|---|--:|--:|--:|--:|--:|
| `viaA` | A | 89 | 7 | 29 | 16 | 77 % |
| `viaA` | calc | 69 | 2 | 23 | 2 | 76 % |
...
| `municipality` | A | 3 | 1 | 3 | 0 |
| `spt_lithology` | A | 0 | 0 | 3 | 1 |
| `spt_n30` | A | 2 | 0 | 2 | 0 |
| `superficie_parcela` | A | 5 | 0 | 2 | 0 |
