...
| **D1** | Cadastre només «als forats»: un valor del tipus equivocat (Polígon/Parcel·la) tapa el forat de la RC | `consolidate.py` ~1788 (gate per format de RC) |
...
| Causa | Castellar | Bell-lloc | Rubí | Total |
|---|---|---|---|---|
| R1 | 2 | 4 | 1 (+1 eix via, per disseny) | 7 |
| R2 | 0 | 2 | 0 | 2 |
| R3 | 0 (legítim) | 1 | 0 | 1 |
| R4 | 0 (derivat) | 2 | 2 | 4 |
| R5 | 1 | 1 | 1 | 3 |
