# Agregat mecànic — mesura d'informe `2026-09-06-informe-p2`
...
|---|---|---|---|---|
| castellar | 40 · 12 · 13 → **80 %** | 43 · 13 · 9 → **86 %** | 43 · 13 · 9 → **86 %** | 29 · 10 · 26 → **60 %** |
| rubi | 38 · 8 · 9 → **84 %** | 38 · 8 · 9 → **84 %** | 39 · 7 · 9 → **84 %** | 31 · 7 · 17 → **69 %** |
| bell-lloc | 33 · 7 · 15 → **73 %** | 34 · 7 · 14 → **75 %** | 33 · 7 · 15 → **73 %** | 35 · 7 · 13 → **76 %** |
| **Total** | 111 · 27 · 37 → **79 %** | 115 · 28 · 32 → **82 %** | 115 · 27 · 33 → **81 %** | 95 · 24 · 56 → **68 %** |
...
| geotecnica | 1/1/5 | 4/2/1 | 4/2/1 | 3/2/2 |
...
| geotecnica | 2/1/4 | 2/1/4 | 2/1/4 | 1/1/5 |
...
- `geotecnica` 1r[1] **MISMATCH** «23» ↔ «25-R»
...
**bell-lloc** (12 cel·les no-MATCH)

- `geotecnica` 1r[0] **CLOSE** «1er nivell. Graves incloses en matriu sorrenca d'aspectes carbonatats, i de coloracions clares.» ↔ «1er nivell. Graves en matriu sorrenca»
- `geotecnica` 1r[1] **MISMATCH** «23» ↔ «25-R»
- `geotecnica` 1r[2] **MISMATCH** «58» ↔ «54»
- `geotecnica` 1r[5] **MISMATCH** «33°» ↔ «38º»
- `geotecnica` 1r[6] **MISMATCH** «114» ↔ «650»
- `soil_levels` 1r[1] **CLOSE** «Graves incloses en matriu sorrenca d'aspectes carbonatats, i de coloracions clares» ↔ «Graves en matriu sorrenca carbonatades»
- `sismica` 1[1] **CLOSE** «Tipus III» ↔ «Tipus II»
- `sismica` 1[2] **MISMATCH** «2.60» ↔ «2.45»
- `sismica` 1[3] **MISMATCH** «1.6» ↔ «1.30»
...
| projecte | variant | Df | nivell portant (idx: descripció) | N20 | Nb | φ | γ | c | E | Qa (uncapped, gov) | assent. cm |
|---|---|--:|---|--:|--:|--:|--:|--:|--:|---|--:|
| **castellar** | *signat* | | | | 17-R | 35 | 2.2 | 1.0 | >500 | **3.0** | <1,0 |
| castellar | `8b` | 0.3 | 1: Roca / material dur (roca pochimada / fora po | 22.56 | 27.2 | 30.5 | 1.9 | 0.05 | 114 | 2.00 (1.84, terzaghi) | 1.80 |
| castellar | `calc` | 0.3 | 1: Roca / material dur (roca pochimada / fora po | 22.56 | 27.2 | 35.0 | 2.2 | 1.0 | 500 | 3.00 (27.20, cap) | 2.80 |
| castellar | `t2` | 0.3 | 1: Roca / material dur (roca pochimada / fora po | 22.56 | 27.2 | 35.0 | 2.2 | 1.0 | 500 | 3.00 (27.20, cap) | 2.80 |
| castellar | `viab` | 0.3 | 1: Roca / material dur (roca pochimada / fora po | 22.56 | 27.2 | 35.0 | 2.2 | 1.0 | 500 | 3.00 (27.20, cap) | 2.80 |
| **rubi** | *signat* | | | | 47-R | 39 | 2.0 | 0.05 | 450 | **3.5** | 1,50 |
| rubi | `8b` | 1 | 0: Graves i sorres (Nivell 1) | 34.8 | 41.9 | 37.1 | 2 | 0 | 469 | 3.50 (5.25, cap) | 1.70 |
| rubi | `calc` | 1 | 0: Graves i sorres (Nivell 1) | 34.8 | 41.9 | 37.17926250456371 | 2.0 | 0.0 | 469.06199999999995 | 3.50 (5.30, cap) | 1.70 |
| rubi | `t2` | 1 | 0: Graves i sorres (Nivell 1) | 34.8 | 41.9 | 37.17926250456371 | 2.0 | 0.0 | 469.06199999999995 | 3.50 (5.30, cap) | 1.70 |
| rubi | `viab` | 1 | 0: Graves i sorres (Nivell 1) | 34.8 | 41.9 | 37.17926250456371 | 2.0 | 0.0 | 469.06199999999995 | 3.50 (5.30, cap) | 1.70 |
| **bell-lloc** | *signat* | | | | 25-R | 38 | 2.0 | 0.0 | 650 | **3.0** | <1,20 |
| bell-lloc | `8b` | 0.3 | 0: Graves carbonatades | 18.75 | 22.6 | 34.6 | 2 | 0.05 | 467 | 3.00 (3.06, cap) | 2.10 |
| bell-lloc | `calc` | 0.3 | 0: Graves carbonatades | 18.75 | 22.6 | 32.87779690189329 | 2.0 | 0.0 | 114.20639999999999 | 1.50 (1.47, terzaghi) | 1.00 |
| bell-lloc | `t2` | 0.3 | 0: Graves carbonatades | 18.75 | 22.6 | 32.87779690189329 | 2.0 | 0.0 | 114.20639999999999 | 1.50 (1.47, terzaghi) | 1.00 |
| bell-lloc | `viab` | 0.3 | 0: Graves carbonatades | 18.75 | 22.6 | 32.87779690189329 | 2.0 | 0.0 | 114.20639999999999 | 1.50 (1.47, terzaghi) | 1.00 |
