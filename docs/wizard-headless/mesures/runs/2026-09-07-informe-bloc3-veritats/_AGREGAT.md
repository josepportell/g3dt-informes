# Agregat mecànic — mesura d'informe `2026-09-07-informe-bloc3-veritats`
...
|---|---|---|---|---|
| castellar | 44 · 10 · 11 → **83 %** | 48 · 10 · 7 → **89 %** | 48 · 10 · 7 → **89 %** | 34 · 7 · 24 → **63 %** |
| rubi | 38 · 9 · 8 → **85 %** | 40 · 9 · 6 → **89 %** | 41 · 8 · 6 → **89 %** | 33 · 8 · 14 → **75 %** |
| bell-lloc | 37 · 5 · 13 → **76 %** | 39 · 5 · 11 → **80 %** | 39 · 4 · 12 → **78 %** | 40 · 5 · 10 → **82 %** |
| **Total** | 119 · 24 · 32 → **82 %** | 127 · 24 · 24 → **86 %** | 128 · 22 · 25 → **86 %** | 107 · 20 · 48 → **73 %** |
...
| mostra_lab | 2/3/0 | 2/3/0 | 2/3/0 | 2/3/0 |
...
| spt_ma | 3/0/2 | 3/0/2 | 3/1/1 | 3/0/2 |
| mostra_lab | 4/1/0 | 4/1/0 | 4/1/0 | 4/1/0 |
...
- `sismica` 1[2] **MISMATCH** «2.60» ↔ «2.45»
- `spt_ma` spt-1[3] **MISMATCH** «62» ↔ «54»
- `spt_ma` spt-1[4] **CLOSE** «Grava amb matriu sorrenca» ↔ «Graves en matriu sorrenca»
- `sondeig` s-1[3] **MISMATCH** «1/0» ↔ «1/--»
