# Agregat M341 — mesura completa `2026-09-07-m341-peca3`
...
| linyola | 7 | 0 | 3 | — |
| alcoletge | 7 | 0 | 3 | — |
| vilanova | 7 | 2 | 1 | `fig_main_plan_image`, `fig_geological_image` |
...
| rubi | 1 | 0 | 4 | 2 | 20 % | 0 | `fig_situacio`:X, `foto_vista`:ND, `fig_assaigs`:X, `foto_dpsh`:X, `fig_geologic`:ND, `fig_tall`:X |
| bell-lloc | 6 | 0 | 3 | 1 | 67 % | 0 | `fig_situacio`:ND, `fig_situacio`:X, `fig_projecte`:X, `fig_geologic`:X |
| linyola | 1 | 1 | 4 | 1 | 33 % | 0 | `fig_situacio`:X, `fig_assaigs`:ND, `fig_projecte`:X, `foto_dpsh`:X, `fig_geologic`:X |
| alcoletge | 2 | 0 | 4 | 0 | 33 % | 0 | `fig_situacio`:X, `fig_assaigs`:X, `foto_dpsh`:X, `fig_geologic`:X |
| vilanova | 2 | 1 | 2 | 4 | 60 % | 1 | `fig_situacio`:X, `fig_projecte`:ND, `foto_vista`:X, `fig_assaigs`:ND, `fig_geologic`:ND, `foto_materials`:ND |
| anciles | 3 | 0 | 3 | 4 | 50 % | 0 | `fig_situacio`:X, `fig_projecte`:ND, `fig_projecte`:ND, `fig_assaigs`:X, `foto_sondeig`:X, `fig_geologic`:ND, `foto_materials`:ND |
| **total** | **17** | **3** | **23** | **13** | **47 %** | | |
