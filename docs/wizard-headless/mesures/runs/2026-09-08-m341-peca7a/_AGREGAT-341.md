# Agregat M341 — mesura completa `2026-09-08-m341-peca7a`
...
| alcoletge | 7 | 0 | 6 | — |
| vilanova | 9 | 0 | 4 | — |
| anciles | 7 | 1 | 5 | `fig_geological_image` |
...
| linyola | 1 | 1 | 4 | 1 | 33 % | 0 | `fig_situacio`:X, `fig_assaigs`:X, `fig_projecte`:ND, `foto_dpsh`:X, `fig_geologic`:X |
...
| anciles | 5 | 0 | 1 | 4 | 83 % | 0 | `fig_projecte`:ND, `fig_projecte`:ND, `foto_sondeig`:X, `fig_geologic`:ND, `foto_materials`:ND |
| **total** | **29** | **4** | **13** | **10** | **72 %** | | |
