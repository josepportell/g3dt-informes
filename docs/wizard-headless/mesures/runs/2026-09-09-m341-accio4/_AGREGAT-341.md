# Agregat M341 — mesura completa `2026-09-09-m341-accio4`
...
|---|---|---|---|---|
| castellar | 60 · 4 · 11 · 5 → **85 %** | 54 · 5 · 15 · 6 → **80 %** | 50 · 10 · 5 → **92 %** | 48 · 10 · 7 → **89 %** |
...
| alcoletge | 46 · 4 · 15 · 8 → **77 %** | — | 37 · 13 · 17 → **75 %** | — |
| vilanova (es) | 21 · 10 · 24 · 5 → **56 %** | — | 28 · 23 · 23 → **69 %** | — |
| anciles (es) | 24 · 7 · 24 · 8 → **56 %** | — | 45 · 27 · 24 → **75 %** | — |
| **Total** | 314 · 44 · 121 · 31 → **75 %** | 160 · 15 · 51 · 10 → **77 %** | 292 · 99 · 88 → **82 %** | 128 · 22 · 25 → **86 %** |
...
|---|---|--:|--:|--:|--:|--:|
| ca | castellar, rubi, bell-lloc, linyola, alcoletge | 30 | 19 | 27 | 3 | 64 % |
...
| linyola | 2 | 0 | 5 | 0 | 29 % | 0 | `fig_situacio`:X, `fig_assaigs`:X, `fig_projecte`:X, `foto_dpsh`:X, `fig_geologic`:X |
| alcoletge | 4 | 0 | 2 | 0 | 67 % | 0 | `foto_dpsh`:X, `fig_geologic`:X |
| vilanova | 5 | 0 | 2 | 2 | 71 % | 1 | `fig_projecte`:ND, `foto_vista`:X, `fig_assaigs`:X, `foto_materials`:ND |
