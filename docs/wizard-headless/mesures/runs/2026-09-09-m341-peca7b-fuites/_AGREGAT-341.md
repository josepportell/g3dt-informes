# Agregat M341 — mesura completa `2026-09-09-m341-peca7b`
...
| rubi | 50 · 8 · 14 · 4 → **81 %** | 48 · 7 · 18 · 3 → **75 %** | 43 · 8 · 4 → **93 %** | 41 · 8 · 6 → **89 %** |
...
| anciles (es) | 25 · 7 · 23 · 8 → **58 %** | — | 45 · 27 · 24 → **75 %** | — |
| **Total** | 314 · 43 · 121 · 32 → **75 %** | 158 · 14 · 53 · 11 → **76 %** | 292 · 99 · 88 → **82 %** | 128 · 22 · 25 → **86 %** |
...
| `viaA` | narr | 34 | 28 | 40 | 7 | 61 % |
| `viaA` | fix | 80 | 0 | 22 | 0 | 78 % |
...
| alcoletge | 7 | 0 | 6 | — |
| vilanova | 9 | 0 | 4 | — |
| anciles | 9 | 1 | 3 | `fig_geological_image` |
...
| rubi | 4 | 1 | 1 | 1 | 83 % | 0 | `foto_vista`:ND, `foto_dpsh`:X |
| bell-lloc | 7 | 0 | 2 | 1 | 78 % | 0 | `fig_situacio`:ND, `fig_situacio`:X, `fig_geologic`:X |
...
| anciles | 5 | 0 | 3 | 2 | 62 % | 0 | `fig_projecte`:X, `fig_projecte`:X, `foto_sondeig`:X, `fig_geologic`:ND, `foto_materials`:ND |
| **total** | **30** | **4** | **16** | **6** | **68 %** | | |
...
| `fig_spt_cullera_num` | fix | 5 | 0 | 2 | 0 |
