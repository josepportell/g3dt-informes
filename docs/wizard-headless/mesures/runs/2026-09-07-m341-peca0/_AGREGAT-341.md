# Agregat M341 — mesura completa `2026-09-07-m341-peca0`
...
|---|---|---|---|---|
| castellar | 58 · 3 · 14 · 5 → **81 %** | 51 · 5 · 18 · 6 → **76 %** | 50 · 10 · 5 → **92 %** | 48 · 10 · 7 → **89 %** |
| rubi | 46 · 8 · 17 · 4 → **76 %** | 44 · 7 · 21 · 3 → **71 %** | 43 · 8 · 4 → **93 %** | 41 · 8 · 6 → **89 %** |
| bell-lloc | 65 · 6 · 9 · 1 → **89 %** | 61 · 2 · 16 · 2 → **80 %** | 42 · 4 · 9 → **84 %** | 39 · 4 · 12 → **78 %** |
| linyola | 51 · 4 · 21 · 1 → **72 %** | — | 47 · 14 · 6 → **91 %** | — |
| alcoletge | 41 · 5 · 17 · 8 → **73 %** | — | 37 · 13 · 17 → **75 %** | — |
| vilanova (es) | 23 · 10 · 21 · 6 → **61 %** | — | 28 · 23 · 23 → **69 %** | — |
| anciles (es) | 24 · 7 · 24 · 8 → **56 %** | — | 45 · 27 · 24 → **75 %** | — |
| **Total** | 308 · 43 · 123 · 33 → **74 %** | 156 · 14 · 55 · 11 → **76 %** | 292 · 99 · 88 → **82 %** | 128 · 22 · 25 → **86 %** |
...
|---|--:|--:|--:|--:|--:|--:|---|
| castellar | 2 | 1 | 3 | 1 | 50 % | 1 | `fig_situacio`:M, `fig_assaigs`:N, `foto_dpsh`:M, `fig_geologic`:M |
| rubi | 1 | 1 | 3 | 2 | 40 % | 0 | `fig_situacio`:M, `foto_vista`:N, `fig_assaigs`:M, `fig_geologic`:N, `fig_tall`:M |
| bell-lloc | 3 | 1 | 6 | 0 | 40 % | 0 | `fig_situacio`:M, `fig_situacio`:M, `fig_projecte`:M, `foto_vista`:M, `foto_sondeig`:M, `fig_geologic`:M |
| linyola | 1 | 0 | 5 | 1 | 17 % | 1 | `fig_situacio`:M, `fig_assaigs`:N, `fig_projecte`:M, `foto_dpsh`:M, `fig_geologic`:M, `fig_tall`:M |
| alcoletge | 1 | 1 | 4 | 0 | 33 % | 1 | `fig_situacio`:M, `fig_assaigs`:M, `foto_dpsh`:M, `fig_geologic`:M |
| vilanova | 2 | 1 | 1 | 5 | 75 % | 0 | `fig_situacio`:M, `fig_projecte`:N, `foto_vista`:N, `fig_assaigs`:N, `fig_geologic`:N, `foto_materials`:N |
| anciles | 1 | 1 | 4 | 4 | 33 % | 0 | `fig_situacio`:M, `fig_projecte`:N, `fig_projecte`:N, `fig_assaigs`:M, `foto_sondeig`:M, `fig_geologic`:N, `foto_materials`:N, `foto_materials`:M |
| **total** | **11** | **6** | **26** | **13** | **40 %** | | |
...
| `fig_correlation_num` | fix | 2 | 0 | 3 | 0 |
...
| `fig_aerea_num` | fix | 1 | 0 | 0 | 0 |
| `fig_cadastre_num` | fix | 1 | 0 | 0 | 0 |
| `fig_main_plan_num` | fix | 1 | 0 | 0 | 0 |
