# Agregat M341 — mesura completa `2026-09-07-m341-peca0b`
...
|---|--:|--:|--:|--:|--:|--:|---|
| castellar | 2 | 1 | 3 | 1 | 50 % | 1 | `fig_situacio`:X, `fig_assaigs`:ND, `foto_dpsh`:X, `fig_geologic`:X |
| rubi | 2 | 0 | 3 | 2 | 40 % | 0 | `fig_situacio`:X, `foto_vista`:ND, `fig_assaigs`:X, `fig_geologic`:ND, `fig_tall`:X |
| bell-lloc | 3 | 1 | 6 | 0 | 40 % | 0 | `fig_situacio`:X, `fig_situacio`:X, `fig_projecte`:X, `foto_vista`:X, `foto_sondeig`:X, `fig_geologic`:X |
| linyola | 1 | 0 | 5 | 1 | 17 % | 1 | `fig_situacio`:X, `fig_assaigs`:ND, `fig_projecte`:X, `foto_dpsh`:X, `fig_geologic`:X, `fig_tall`:X |
| alcoletge | 1 | 1 | 4 | 0 | 33 % | 1 | `fig_situacio`:X, `fig_assaigs`:X, `foto_dpsh`:X, `fig_geologic`:X |
