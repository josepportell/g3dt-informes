# Agregat mecànic — mesura d'informe `2026-09-07-informe-bloc1b`
...
| bell-lloc | 37 · 5 · 13 → **76 %** | 39 · 5 · 11 → **80 %** | 38 · 5 · 12 → **78 %** | 40 · 5 · 10 → **82 %** |
| **Total** | 119 · 24 · 32 → **82 %** | 127 · 24 · 24 → **86 %** | 127 · 23 · 25 → **86 %** | 107 · 20 · 48 → **73 %** |
