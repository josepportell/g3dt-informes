# Agregat M341 — mesura completa `2026-09-07-m341-bloc3-veritats`
...
|---|---|---|---|---|
| castellar | 43 · 3 · 9 · 6 → **84 %** | 36 · 5 · 13 · 7 → **76 %** | 50 · 10 · 5 → **92 %** | 48 · 10 · 7 → **89 %** |
| rubi | 35 · 8 · 12 · 5 → **78 %** | 33 · 7 · 16 · 4 → **71 %** | 43 · 8 · 4 → **93 %** | 41 · 8 · 6 → **89 %** |
| bell-lloc | 45 · 6 · 8 · 2 → **86 %** | 41 · 2 · 15 · 3 → **74 %** | 42 · 4 · 9 → **84 %** | 39 · 4 · 12 → **78 %** |
| linyola | 43 · 4 · 13 · 2 → **78 %** | — | 47 · 14 · 6 → **91 %** | — |
| alcoletge | 30 · 5 · 12 · 9 → **74 %** | — | 37 · 13 · 17 → **75 %** | — |
| vilanova (es) | 16 · 9 · 21 · 7 → **54 %** | — | 28 · 23 · 23 → **69 %** | — |
| anciles (es) | 17 · 7 · 22 · 9 → **52 %** | — | 45 · 27 · 24 → **75 %** | — |
| **Total** | 229 · 42 · 97 · 40 → **74 %** | 110 · 14 · 44 · 14 → **74 %** | 292 · 99 · 88 → **82 %** | 128 · 22 · 25 → **86 %** |
...
| `settlement_sentence` | calc | 4 | 0 | 3 | 0 |
...
| `geomech_phi` | calc | 6 | 0 | 1 | 0 |
| `k30_value` | calc | 1 | 0 | 1 | 0 |
| `bearing_layer_idx` | calc | 0 | 0 | 0 | 7 |
...
| vilanova | 0.3 | 0: Arcilla limosa y arenosa con algunas gra | 22.2 | 25 | 1.9 | 0.1 | 50 | 1.50 (terzaghi) | 3.10 | <1,0 | 25 |
...
- **vilanova/viaA**: errors=[] warnings=['Assentament: ⚠ 3.10 cm supera el topall de servei de 2.54 cm (1 polzada) per a sabates']
